...
while (True): 
    ...
    try:
        ...
        cv2.imwrite('FloatingPoint_Descriptors\\result\\harris_threshold' + str(thresh) + '_rotate1.jpg', out1)
        ...
        cv2.imwrite('FloatingPoint_Descriptors\\result\\harris_threshold' + str(thresh) + '_rotate2.jpg', out2)
